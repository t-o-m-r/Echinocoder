...
def print_first_part_of_simplex_encoding(set_array : np.array,
    ...
    can_lin_comb_2_second_diffs, offsets2 = simplex_method(set_array,
                                                           preserve_scale_in_step_1 = preserve_scale_in_step_1,
                                                           preserve_scale_in_step_2 = preserve_scale_in_step_2,
                                                           canonicalise = True,
                                                           use_assertions = True)
    ...
    can_lin_comb_3 = can_lin_comb_2_second_diffs + offsets2
    ...
    print("and the (non-offset) differences are")
    [ print(EncDec.numpy_array_of_frac_to_str(tmp:=b-a), " with basis one-norm", np.sum(tmp)) for a,b in list(pairwise(  can_lin_comb_3.basis_vecs ))[:-len(offsets2)] ]
...
if __name__ == "__main__":
    ...
    print_first_part_of_simplex_encoding(arr, simplex_method=simplex_method,  preserve_scale_in_step_1=preserve_scale_in_step_1, preserve_scale_in_step_2=preserve_scale_in_step_2)
