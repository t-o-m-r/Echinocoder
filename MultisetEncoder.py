...
class MultisetEncoder:
    ...
    The set to be encode should be inputs as a 2D numpy array with shape (n,k).
    ...
    once only).  Thus all encoders are expected to be able to tell callers what sizes of input they can and cannot embed, and how long the possible embeddings will be.  Derived classes do this by implementing the method
