...
* The [Simplicial Complex](https://en.wikipedia.org/wiki/Simplicial_complex) encoder works for any $n$ and $m$ and encodes into $n*m+1$ reals. [source](C0_numpy_simplicalComplex_encoder_for_array_of_reals_as_multiset.py)
