...
* The [Simplicial Complex](https://en.wikipedia.org/wiki/Simplicial_complex) encoder works for any $n$ and $m$ and encodes into $n\cdot m+1$ reals. ([encoder source](C0_numpy_simplicialComplex_encoder_for_array_of_reals_as_multiset.py))
