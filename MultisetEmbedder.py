...
class MultisetEmbedder:
    ...
    canonicalise their input sets.  Someone wanting bit-for-bit identical output under permu-
    tations of input vectors could easily sort their vectors (in any way) prior to using any 
    embedder.
